...
t_fit = np.linspace(0.03, 2.2, 100, endpoint=True)
x_fit = param_1 * t_fit ** param_2

ax.errorbar(t, x, xerr=0.015, yerr=10, marker='o', linestyle='', color="C1")
ax.loglog(t_fit, x_fit, color="C1")
...
t_fit = np.linspace(0.03, 0.5, 100, endpoint=True)
x_fit = param_1 * t_fit ** param_2
...
t_fit = np.linspace(0.6, 5.5, 100, endpoint=True)
x_fit = param_1 * t_fit ** param_2
